   ...
   <div class="w-screen h-screen" style="background-color: #ADD8E6">
       <div class="flex flex-row">
          <div class="w-1/2 h-screen pt-16">
            <img src="{{ asset('images/medicin1.svg') }}" alt="" class="wow bounceIn" data-wow-delay=".5s" data-wow-duration=".9s">
          </div>
          <div class="w-1/2 h-screen">
              <div class="form-container flex flex-col items-center justify-center w-auto h-full">
                 <div class="card-form bg-white shadow border p-4 w-2/3 wow fadeIn" data-wow-delay=".7s" data-wow-duration="1s">
                     ...
                     <form action="{{ route('structure.login.store') }}" method="post" class="mt-10">
                        @csrf
                        <div class="mb-6">
                        ...
                        <small>Vous n'avez pas de compte? cliquer <a href="{{ route('structure.register.form') }}" class="text-blue-600"> ici</a></small>
                     </form>
                 </div>
              </div>
          </div>
