...
<div class="form-content border shadow-md my-16 mx-24">
    ...
    <div class="body py-8 px-4">
         <form action="{{ route('rdv_examen_store') }}" method="post">
             @csrf
             <div class="mt-8 mb-10">
                 <div class="flex justify-between w-full">
                     <div class="w-full">
                         <label for="examen" class="font-semibold mb-2 block text-gray-900">Choisissez le type d'examen que vous voulez éffectuer <span class="text-red-600">*</span></label>
                         <select name="examen" id="examen" class="form-control bg-transparent w-full @error('examen') border-red-500 @enderror">
