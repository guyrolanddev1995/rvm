...
<main class="mx-auto container">
    <div class="form-content border shadow-md my-16 mx-40">
        <div class="header py-4 px-4 flex justify-between">
            <h3 class="text-xl font-semibold text-gray-800 uppercase">Détails de prise de rendez-vous d'examen radiologique/biologique</h3>
        ...
        <div class="body py-8 px-4">
            <table class="w-full">
                ...
                <tr>
                    <td class="py-3  mb-4" width="50%">
                        <h2 class="uppercase font-semibold text-gray-800">Examen</h2>
                    </td>
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::upper( $examen->nom) }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="py-3  mb-4" width="50%">
                ...
                @if($data['step2'][0]['praticien'] !== null)
                <tr>
                    <td class="py-3  mb-4" width="50%">
                ...
                <tr>
                    ...
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::upper($data['step2'][0]['date']) }}</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::upper($data['step2'][0]['heure']) }} H</p>
                    </td>
                </tr>
                <tr>
                    <td class="py-3  mb-4" width="50%">
                    ...
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::ucfirst($data['step2'][0]['motif']) }}</p>
                    </td>
                </tr>
                <tr>
                    <td class="py-3  mb-4" width="50%">
                    ...
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::upper($data['step2'][0]['assure']) }} </p>
                    </td>
                </tr>
                @if($data['step2'][0]['assurence'] !== null)
                <tr>
                    <td class="py-3  mb-4" width="50%">
                        <h2 class="uppercase font-semibold text-gray-800">Assurence</h2>
                    </td>
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::upper($data['step2'][0]['assurence']) }} </p>
                    </td>
                </tr>
                @endif
                @if($data['step2'][0]['other'] !== null)
                <tr>
                    <td class="py-3  mb-4" width="50%">
                        <h2 class="uppercase font-semibold text-gray-800">Autre assurence</h2>
                    </td>
                    <td class="py-3  mb-4"  width="50%">
                        <p class="">{{ Str::upper($data['step2'][0]['other']) }} </p>
                    </td>
                </tr>
                @endif
            </table>
            ...
            <div class="ml-auto flex justify-end">
                ...
                <a href="{{ route('examen.store') }}" class="bg-blue-600 text-white p-2 text-center ml-4">Confirmer <i class="fa fa-check" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
 </main>
